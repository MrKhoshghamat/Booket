...
using Booket.Modules.UserManagement.Infrastructure.Configuration.Processing.Inbox;
using Booket.Modules.UserManagement.Infrastructure.Configuration.Processing.InternalCommands;
...
namespace Booket.Modules.UserManagement.Infrastructure.Configuration.Quartz
{
    internal static class QuartzStartup
    {
        internal static void Initialize(ILogger logger, long? internalProcessingPoolingInterval = null)
        {
            ...
            schedulerConfiguration.Add("quartz.scheduler.instanceName", "Booket");
